    ...
    const hfuzz_mutation_counters_t* mutation)
{
    ...
    if (vector_enabled_.load()) {
        ...
        if (s_exec_events_enabled) {
            ...
            jb.add("lpm_mutate_cnt", m->lpm_mutate_cnt);
            jb.add("lpm_crossover_cnt", m->lpm_crossover_cnt);
            jb.add("lpm_parse_success_cnt", m->lpm_parse_success_cnt);
            jb.add("lpm_parse_fail_cnt", m->lpm_parse_fail_cnt);
    ...
    APPEND_UINT64_COLUMN(b, "lpm_mutate_cnt", m->lpm_mutate_cnt);
    APPEND_UINT64_COLUMN(b, "lpm_crossover_cnt", m->lpm_crossover_cnt);
    APPEND_UINT64_COLUMN(b, "lpm_parse_success_cnt", m->lpm_parse_success_cnt);
    APPEND_UINT64_COLUMN(b, "lpm_parse_fail_cnt", m->lpm_parse_fail_cnt);
